export const ABOUT_CARDS = [
    {
        ...
        email: "albin.karvling@hotmail.com",
    },
    {
        name: "Hector",
        title: "Relationschef",
        image: "/imgs/hector.jpg",
        quote: "Som relationschef är mitt mål att inte bara möta utan överträffa våra kunders förväntningar. Jag brinner för att skapa mervärde och leverera enastående kundupplevelser. Varje dag strävar jag efter att vara en pålitlig partner för att hjälpa dig att nå dina affärsmål och skapa långsiktiga framgångar.",
        telephone: '079-349 88 70',
    ...
    },
    {
        ...
        email: "ludvig.bergstrom@hotmail.com",
    }
];
